...
📊 **Power BI:** Used to design and build an interactive dashboard with insightful visualizations and business-friendly reports.<br><br>
📈 **DAX (Data Analysis Expressions):** Used to create calculated measures, KPIs, and custom business logic for deeper sales analysis.<br><br>
⚡ **Power Query:** Used for data transformation, merging tables, and creating a clean and structured data model.<br><br>
...
5. ⭐ Features & Highlights<br><br>

📊 **Interactive Visualizations:** Dynamic charts and graphs that allow users to explore sales data from multiple perspectives.<br>
🎛️ **Filters & Slicers:** Easy filtering by month, region, product, and customer for deeper analysis.<br>
📈 **KPI Tracking:** Displays key metrics such as total sales, profit, revenue, and order count in real-time style cards.<br>
🐍 **Data Preprocessing (Python - Pandas):** Cleaned and prepared raw dataset for accurate analysis and reporting.<br>
**Key Questions**

📊 What is the total monthly sales, revenue, and profit performance?<br>
📈 How do sales trends change over different months?<br>
