...
The dataset used for this project was obtained from **Kaggle**. It contains monthly sales data, including information on orders, products, customers, revenue, and profit. The data was cleaned and preprocessed using **Python (Pandas)** and **SQL** before being transformed into an interactive **Power BI** dashboard for analysis and visualization.


5. ⭐ Features & Highlights

📊 **Interactive Visualizations:** Dynamic charts and graphs that allow users to explore sales data from multiple perspectives.
🎛️ **Filters & Slicers:** Easy filtering by month, region, product, and customer for deeper analysis.
📈 **KPI Tracking:** Displays key metrics such as total sales, profit, revenue, and order count in real-time style cards.
🐍 **Data Preprocessing (Python - Pandas):** Cleaned and prepared raw dataset for accurate analysis and reporting.
**Key Questions**

📊 What is the total monthly sales, revenue, and profit performance?
📈 How do sales trends change over different months?
🏆 Which products are the top-performing and least-performing?
🌍 Which regions or locations generate the highest sales?
